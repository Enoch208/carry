...
// Public fullnode.<net>.sui.io endpoints no longer serve raw JSON-RPC — use working public RPCs.
export const NETWORKS: Record<Network, NetCfg> = {
  testnet: {
    ...
    rpcUrl: process.env.SUI_RPC_URL || "https://sui-testnet-rpc.publicnode.com",
  ...
  mainnet: {
    ...
    rpcUrl: process.env.SUI_MAINNET_RPC_URL || "https://rpc-mainnet.suiscan.xyz",
