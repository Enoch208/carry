...
const tiers = [
  ...
  },
  {
    ...
    cta: { kind: "gradient" as const, label: "Follow along", href: "https://github.com" },
  },
  {
    phase: "Vision",
    title: "Where it goes",
    desc: "The track’s real frontier.",
    highlight: false,
    badge: null,
    features: [
    ...
    cta: { kind: "outline" as const, label: "Read the vision", href: "#" },
  },
];

export function Roadmap() {
  return (
    <section className="mx-auto w-full max-w-7xl border-x border-t border-dashed border-white/20 bg-[#050505]">
